...
files_nanomefos = '25264_Subsrat_SW_SN1 1_Full_woTilt.datx'
files_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/FM_SW_SN1/Zygo/Form/20260223/substrates_template_FM_form_casquette_Bertin_bascule_nouveau_code_test_nina.fits'
...
# files_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/FM_SW_SN5/Zygo/Form/20211202/substrate_FM_form_SW_SN5_full.fits'
# dx_nanomefos = 60 # SW5
# dy_nanomefos=140
dx_nanomefos = 60 # SW5
dy_nanomefos=140
...
# plt.imshow(zygo_data.sag, aspect="equal", origin="lower")
# plt.show()
measured_surface_zygo = surfaces.MeasuredSurface(zygo_data, alpha=0, beta=0, gamma=0)

measured_substrate_zygo = surfaces.Substrate(measured_surface_zygo,rectangular_sw_substrate.aperture,rectangular_sw_substrate.useful_area)
...
im1 = ax[0].imshow(map1, origin='lower',vmin=-4000, vmax=4000,extent=measured_substrate_zygo.aperture.limits)
ax[0].set_title("Nanomefos")
fig.colorbar(im1, ax=ax[0], label="Intensity")


im2 = ax[1].imshow(map2, origin='lower',vmin=-4000, vmax=4000,extent=measured_substrate_zygo.limits)
ax[1].set_title("Zygo")
...
diff=map2-map1
im3 = ax[2].imshow(diff, origin='lower', vmin=-40, vmax=40,extent=measured_substrate_zygo.limits)
