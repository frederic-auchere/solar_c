...
cases = [
    dict(
        name="LW_SN1",
        file_zygo= path_individuel + r"",
        file_rugo = path_individuel + r"\08 - Metrology\01 - Optics\08 - Bertin\SW_SN1\SW-SN1_Rugo_mesure.datx",
    ),
    dict(
        name="SW_SN1",
        file_zygo= path_individuel + r"",
        file_rugo = path_individuel + r"",
    ),
    dict(
        name="SW_SN2",
    ...
    dict(
        name="SW_SN4",
        file_zygo= path_individuel + "",
        file_rugo = path_individuel + "",
    ),
    dict(
        name="SW_SN5",
        file_zygo= path_individuel + r"\08 - Metrology\01 - Optics\07 - Measurements\FM\SW\FM_SW_SN5\Zygo\Form\20211202\substrate_FM_form_SW_SN5.fits",
        file_rugo = path_individuel + r"\08 - Metrology\01 - Optics\08 - Bertin\SW_SN5\25-11-03_SW-SN5_rugo1.datx",
    ),
    dict(
        name="SW_SN6",
    ...
    dict(
        ...
        file_rugo = path_individuel + r"\08 - Metrology\01 - Optics\08 - Bertin\SW_SN7\25-11-07_SW-SN7_rugo.datx",
    ),
    dict(
        name="SW_SN8",
        ...
        file_rugo = path_individuel + r"\08 - Metrology\01 - Optics\08 - Bertin\SW_SN8\25-11-13_SW-SN8_rugo.datx",
    ),
    dict(
        name="SW_SN9",
...
# =========================================================
# ============ VARIABLE GLOBALE DE SELECTION =============
# =========================================================
substrate_name = "SW_SN9"   #à changer pour changer de substrat étudié

# Récupération du cas correspondant dans la liste "cases"
case = next((c for c in cases if c["name"] == substrate_name), None)
if case is None:
    raise ValueError(f"Substrat '{substrate_name}' introuvable dans la liste 'cases'")

files_zygo = case["file_zygo"]
files_roughness = case["file_rugo"]
...
#plt.loglog(nu_x1[1:], psd_x[1:], label="Cut X rugo") a decommenter si rugo
...
#plt.loglog(nu_y1[1:], psd_y[1:], label="Cut Y rugo") a decommenter si rugo
...
plt.suptitle(substrate_name.replace("_", " "))
plt.show()
