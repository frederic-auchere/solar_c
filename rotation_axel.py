...
z = measured_substrate.sag((x,y)) #x et y tournés depuis EGA-O vers normal et sag calculé en ces points là
...
nx, ny, nz = rectangular_sw_substrate.surface.inverse_rotation_matrix() @ xyz
...
nz = griddata((nx, ny), nz, (ox, oy), method='cubic', rescale=False).reshape(ox.shape)
