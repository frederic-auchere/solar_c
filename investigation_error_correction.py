...
cases = [
    ...
    dict(
        ...
        file_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/carte_correction_sw/carte_correction_SW_SN5.datx',
    ...
    dict(
        ...
        dx_nanomefos=60, dy_nanomefos=140,
        file_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/carte_correction_sw/carte_correction_SW_SN7.datx',
    ),
    dict(
        name="SW_SN8",
        ...
        dx_nanomefos=60, dy_nanomefos=140,
        file_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/carte_correction_sw/carte_correction_SW_SN8.datx',
    ),
    # dict(
    #     name="SW_SN1",
...
vmin_global, vmax_global = -500,500
for ax in axes:
