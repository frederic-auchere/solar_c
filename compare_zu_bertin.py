...
files_zygo='/Volumes/solarc/02- Engineering/08 - Metrology/01 - Optics/07 - Measurements/FM/SW/FM_SW_SN5/Zygo/Form/20211202/report.fits'
dx_nanomefos = 0
dy_nanomefos=189
...
im1 = ax[0].imshow(map1, origin='lower')
ax[0].set_title("Nanomefos")
fig.colorbar(im1, ax=ax[0], label="Intensity")


im2 = ax[1].imshow(map2, origin='lower')
ax[1].set_title("Zygo")
...
diff=map2-map1
im3 = ax[2].imshow(diff, origin='lower')
